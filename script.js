let myListOfObj = [
    {"img":"img1.jpg","name":"James Edith","position":"WEB DEVELOPER","desc":"Developing web is fun! you will learn how to create a carousel of reviews with a button that generates random reviews. This is a good feature to have on an ecommerce site to display customer reviews or a personal portfolio to display client reviews."},
    {"img":"img2.jpg","name":"Holy Mclean","position":"UX DESIGNER","desc":"UX Design is fun! you will learn how to create a carousel of reviews with a button that generates random reviews. This is a good feature to have on an ecommerce site to display customer reviews or a personal portfolio to display client reviews."},
    {"img":"img3.jpg","name":"Cassie Liu","position":"SOFTWARE ENGINEER","desc":"Developing software is fun! you will learn how to create a carousel of reviews with a button that generates random reviews. This is a good feature to have on an ecommerce site to display customer reviews or a personal portfolio to display client reviews."},
    {"img":"img4.jpg","name":"Susan Smith","position":"RESEARCHER","desc":"Researching is fun! you will learn how to create a carousel of reviews with a button that generates random reviews. This is a good feature to have on an ecommerce site to display customer reviews or a personal portfolio to display client reviews."},
    {"img":"img5.jpg","name":"Bruce Chen","position":"MANAGER","desc":"Management is fun! you will learn how to create a carousel of reviews with a button that generates random reviews. This is a good feature to have on an ecommerce site to display customer reviews or a personal portfolio to display client reviews."}
];
